...
png("plot4.png");
par(mfrow=c(2,2))
plot(x=febHPCData[,"Time"],y=febHPCData[,"Global_active_power"],xlab="",ylab="Global Active Power",type="l")
plot(x=febHPCData[,"Time"],y=febHPCData[,"Voltage"],xlab="datetime",ylab="Voltage",type="l")
...
plot(x=febHPCData[,"Time"],y=febHPCData[,"Global_reactive_power"],xlab="datetime",ylab="Global_reactive_power",type="l")
dev.off();